  ...
  <div class="container mx-auto my-5 signupform" style="width:50%;">
    ...
    <form action="/customers/create" method = "POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control float-right" id="confirmpassword" name="confirmpassword" required>
            </div>
        </div>
        <div class="form-group row">
    ...
    <p><a href="/customers/login"style="color: white;">Login here</a></p>
      </form>
